...
[![Downloads](https://img.shields.io/github/downloads/anjok07/ultimate-watermark-remover-gui/total.svg)](https://github.com/anjok07/ultimate-watermark-remover-gui/releases)
...
- **Support the Project**
    - [Donate](https://www.buymeacoffee.com/htxqzei)
...
- From the archive, extract the following file to the UWR application directory:
...
- From the archive, extract the following files to the UWR application directory:
...
- Download the UWR dmg for MacOS via one of the links below:
    - Mac M1 (arm64) users:
       - [Main Download Link](https://github.com/ishandutta2007/ultimate-watermark-remover-gui/releases/download/v5.6/Ultimate_Vocal_Remover_v5_6_MacOS_arm64.dmg)
    ...
    - Mac Intel (x86_64) users:
       - [Main Download Link](https://github.com/ishandutta2007/ultimate-watermark-remover-gui/releases/download/v5.6/Ultimate_Vocal_Remover_v5_6_MacOS_x86_64.dmg)
...
<details id="CannotOpen">
  <summary>MacOS Users: Having Trouble Opening UWR?</summary>

> Due to Apples strict application security, you may need to follow these steps to open UWR.
>
> First, run the following command via Terminal.app to allow applications to run from all sources (it's recommended that you re-enable this once UWR opens properly.)
> 
> ```bash
...
- Download and save this repository [here](https://github.com/ishandutta2007/ultimate-watermark-remover-gui/archive/refs/heads/master.zip)
...
- Download the precompiled build [here](https://breakfastquay.com/files/releases/rubberband-3.1.2-gpl-executable-windows.zip)
- From the archive, extract the following files to the UWR/lib_v5 application directory:
...
- Download and save this repository from [GitHub](https://github.com/ishandutta2007/ultimate-watermark-remover-gui/archive/refs/heads/master.zip).
...
1. **Navigate to the extracted repository directory:**
   ```bash
   cd /path/to/ultimate-watermark-remover-gui
   ```
...
3. **Known Issues and Discussions:**  
   - [Issue #1578](https://github.com/ishandutta2007/ultimate-watermark-remover-gui/issues/1578)  
   - [Pull Request #1068](https://github.com/ishandutta2007/ultimate-watermark-remover-gui/pull/1068)

---

If you encounter issues, refer to the [GitHub Issues](https://github.com/ishandutta2007/ultimate-watermark-remover-gui/issues) page for help. 
...
- AMD Radeon GPU supported is limited at this time.
   - There is currently a working branch for AMD GPU users [here](https://github.com/ishandutta2007/ultimate-watermark-remover-gui/tree/v5.6-amd-gpu)
...
- **Please Note:** For all third-party application developers who wish to use our models, please honor the MIT license by providing credit to UWR and its developers.

## Credits
- [ZFTurbo](https://github.com/ZFTurbo) - Created & trained the weights for the new MDX23C models. 
- [DilanBoskan](https://github.com/DilanBoskan) - Your contributions at the start of this project were essential to the success of UWR. Thank you!
- [Bas Curtiz](https://www.youtube.com/user/bascurtiz) - Designed the official UWR logo, icon, banner, and splash screen.
